...
public class Testscenario2 extends TestBase {
	...
	public static void main(String[] args)  throws InterruptedException 
	{
		...
		WebElement Singapore=driver.findElement(By.xpath("//div[@id='hamburger-nav']//ul/li[@class='hamburger-menu__item hamburger-menu__item--active hamburger-menu__item--with-sub']//ul/li//a[text()='Singapore']"));
		String SingaporeText=Singapore.getText();
		
		webdriverWaitClickByJS(Singapore, driver);
		...
		WebElement singaporeInNextPage=driver.findElement(By.xpath("//h1[@class='h1 h1--block-heading block block-video-heading block-layout-builder block-field-blocknodelanding-pagetitle clearfix']/child::span"));
